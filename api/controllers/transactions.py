...
class TransactionController(MethodView):
    ...
    def post(user_id):
        ...
        post_values = DataValidation.validate_transactions(post_data, ['amount', 'receiver_id', 'currency'])
        ...
        if isinstance(post_values, bool):
            ...
            if post_data['currency'] != 'USD':
                post_data['amount'] =  (post_data['amount'] / TransactionController.currencies[post_data['currency']])
